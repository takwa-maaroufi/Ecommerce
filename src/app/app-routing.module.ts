...
const routes : Routes =[
  ...
  {path:"productCategory/:categoryName", component:ProduitListComponent},
  ...
  {path:"faves",component:FaveProductComponent,canActivate:[AuthGuard], data:{roles:['USER']} },
  ...
  {path:"addToWishlist",component:FaveProductComponent,canActivate:[AuthGuard], data:{roles:['USER']} },
  {path:"checkout", component: CheckoutComponent,canActivate:[AuthGuard], data:{roles:['USER']} },
